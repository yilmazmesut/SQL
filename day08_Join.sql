/*============================== JOIN ISLEMLERI ===============================
    foreign key id si ortaklar? yanyana yaz?yordu bu bikaç tablodan istenilen
    sütunlar? al?r birle?tirir. set istenilen sütunlar? tek sütunda birle?tirir
...
-- siparis_id ve siparis_tarihleri listeleyen bir sorgu yaziniz.
    ...
    FROM sirketler s     --id sp den geldigi için sadece sirkette olan 100 id null oldu, bunu görmek için sirket_id ekledim yoksa ?art de?il
    FULL JOIN siparisler sp                      
    ON s.sirket_id = sp.sirket_id;  --join icin where yerine ON kullanilir --burasi için kisa isim verdik,ilk sat?rda
    --kisa isimleri ile ça??rmak ?art de?il(s.sirket_isim gibi)
...
--  siparis_tarihleri listeleyen bir sorgu yaziniz. null olanlar çikm?cak 
--  çünkü NULL ortak degil(bir tabloda null iken di?erinde id null yok, 100, 101 vs var)
...
/*============================== RIGHT JOIN  ==================================
    ...
    ancak ortak olmayan kisimlar bos kalir.1. tablodaki Toyota yaz?lmaz, ortak olmad??? için
    Syntax
    -----------
    SELECT sutun1,sutun2....sutunN
    FROM tablo1
